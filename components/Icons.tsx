...
export const ChatBubbleLeftRightIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 0 1-3.722 0l-3.722-.537A2.25 2.25 0 0 1 3 16.894v-4.286c0-.97.616-1.813 1.5-2.097m16.5 0a2.25 2.25 0 0 0-1.5-2.097l-3.722-.537a5.25 5.25 0 0 0-3.722 0l-3.722.537A2.25 2.25 0 0 0 3 8.511m16.5 0-3.22-3.22m-13.28 0-3.22 3.22m10.022 7.022 3.22-3.22m-10.022 0 3.22 3.22" />
  </svg>
);
